<html>
  ...
  <body>
	...
	<?php 
		...
		try {
			$conn = new PDO("sqlsrv:server = tcp:covidesearch.mysql.database.azure.com,1433; Database = covidsearchcenter", "chisomjude", "{your_password_here}");
		...
		$connectionInfo = array("UID" => "chisomjude", "pwd" => "Favoured0205", "Database" => "covidsearchcenter", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
		$serverName = "tcp:covidesearch.mysql.database.azure.com,1433";
